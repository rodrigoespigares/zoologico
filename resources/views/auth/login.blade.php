<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}" class="form_login">
        ...
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email')" class="labels" />
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label for="password" :value="__('Password')" class="labels" />
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800 input_remember" name="remember">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-3 login">
                {{ __('Log in') }}
            </x-primary-button>
        </div>
    </form>
